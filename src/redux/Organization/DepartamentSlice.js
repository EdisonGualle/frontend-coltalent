...
import { createDepartment, deleteDepartment, getDepartment, getDepartments, updateDepartment } from '../../services/Company/DepartamentService';
...
export const createNewDepartment = createAsyncThunk('departments/createNewDepartment', async (newDepartment) => {
...
export const deleteOneDepartment = createAsyncThunk('departments/deleteOneDepartment', async (department) => {
